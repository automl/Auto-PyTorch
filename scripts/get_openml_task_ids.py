...
if __name__ == "__main__":
    ...
    openml_task_ids = [3945, 146212, 146818, 168868, 189356, 189355, 146606, 34539, 168337, 168338, 168908, 168912, 7593, 168910, 168909, 168911, 189354, 146825, 10101, 9977, 167119, 146822, 167120, 146821, 14965, 12, 31, 3, 168332, 168331, 168330, 168335, 168329, 9952, 7592, 9981, 146195, 53, 3917]
    ...
    for task_id in openml_task_ids:
        ...
        if len(tasks_with_same_dataset['tid'])>0:
            new_task_ids.append(tasks_with_same_dataset['tid'].iloc[0])
        else:
            resplit.append(task_id)
    
    print("New task ids:", new_task_ids)
    print("Resample:", resplit)
