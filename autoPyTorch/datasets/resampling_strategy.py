...
ResamplingStrategiesTypes = Union[HoldoutValTypes, CrossValTypes, NoResamplingStrategyTypes]
DEFAULT_RESAMPLING_PARAMETERS: Dict[ResamplingStrategiesTypes, Dict[str, Any]] = {
