...
if __name__ == "__main__":
    ...
    if args.logging=="step":
        ...
        budget = 50
    logdir = "logs/bench_results_" + args.logging + "_" + args.architecture + "_" + "mixup"  + "/run_" + str(run_id) + "_" + str(openml_task_id)
    ...
    hyperparameter_config["SimpleTrainNode:batch_loss_computation_technique"] = "mixup"
    hyperparameter_config["SimpleTrainNode:mixup:alpha"] = 0.5
