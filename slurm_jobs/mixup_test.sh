...
#SBATCH -J openml_mixup                                 # sets the job name. If not specified, the file name will be used as job name
...
# Array jobs 
python3 run_bench_with_offset_mixup.py --run_id $SLURM_ARRAY_TASK_ID --offset 0 --architecture shapedmlpnet --logging step
